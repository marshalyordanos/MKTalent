...
const PostCard = (props) => {
  ...
  return (
    <div className=" box-content h-50 w-[500px] p-4 justify-start overflow-hidden">
...
<div className=" px-9">
   ...
   <div className="  box-content h-50 w-[500px] overflow-hidden"><img src={Postimg} alt="there should have been a post here"
