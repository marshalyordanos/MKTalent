...
import RightSideBarUserCard from './pages/RightSideBar UserCard';
...
function App() {
  ...
  return (
    ...
    <div className=' box-content bg-slate-100 w-[350px] rounded-xl'>
      
<h1 className=' py-6 text-4xl border-blue-500 w-[73px] border-b-2 mx-6 my-8 '>Members</h1>
<span className="flex flex-rows px-2">
<p className="text-base mx-6 hover:cursor-pointer
border-b-2  
border-slate-100 
hover:border-b-2  
  hover:border-blue-500" onClick={pageNewest}>Newest</p>|
   <p className="text-base mx-6 hover:cursor-pointer hover:border-b-2  
