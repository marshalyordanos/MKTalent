  ...
  return (
    <Videopage1 className=''>
      <div className=' border-b-[1px] mx-7 border-[#e7e7e7]'>
       <p className={`text-lg mt-10 pb-0 border-b-[3px] w-20 border-[#1890FF]  mb-0 ${!light&&"dark:text-white "}`}>All Videos</p>    
      </div>  
      <div className='vedioSearch w-60 mt-7 pb-7 mx-7'>
      <form className="flex justify-between">
      <input className={`w-[12rem] ${!light&&"dark:text-white dark:bg-slate-900"}`} type="text" placeholder='Search vedio' />
